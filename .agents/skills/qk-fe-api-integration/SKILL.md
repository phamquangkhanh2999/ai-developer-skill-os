...
- Ưu tiên sử dụng các Knowledge đang có trạng thái `Active` thuộc:
  ...
  - Pattern
  - Tech Debt Pattern
  - 👉 *Domain Focus:* Pattern / Convention (vd: cách quản lý state TanStack Query/Zustand, binding chuẩn).
...
- Trong quá trình làm việc, AI được phép tự phát hiện và tạo **Candidate Memory** khi nhận thấy:
  ...
  - 👉 *Domain Harvest:* Pattern mới (vd: quy tắc cache/revalidate dữ liệu tầng Frontend).
...
- 👉 *Domain Ignore:* Logic call API của 1 component riêng rẽ.

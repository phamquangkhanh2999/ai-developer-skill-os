...
- Ưu tiên sử dụng các Knowledge đang có trạng thái `Active` thuộc:
  ...
  - Pattern
  - Tech Debt Pattern
  - 👉 *Domain Focus:* Convention / Architecture (vd: ngưỡng định lượng độ phức tạp cyclomatic, DRY, SOLID).
...
- Trong quá trình làm việc, AI được phép tự phát hiện và tạo **Candidate Memory** khi nhận thấy:
  ...
  - 👉 *Domain Harvest:* Convention hoặc ranh giới kỹ thuật mới (vd: áp đặt giới hạn 100 dòng cho file AGENTS.md).
...
- 👉 *Domain Ignore:* Cảnh báo linter tạm thời.
